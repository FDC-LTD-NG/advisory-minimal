export const siteConfig = {
  ...
  description:
    "FDC Balanced Fund is an SEC-approved balanced mutual fund managed by FDC Advisory Limited, Lagos.",
  tagline: "A SEC-approved balanced mutual fund for Nigerian investors.",

  // ADD THIS LINE ↓ — paste your full S3 URL between the quotes
  heroImage:
